...
import { ArrowRight, Calendar, Briefcase, HardHat, Clapperboard } from "lucide-react";
    ...
    <section className="relative min-h-[70vh] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-5 leading-tight animate-fade-in" style={{ animationDelay: '0.1s' }}>
            Partner with Gradia.
            <br />
          ...
          <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: '0.2s' }}>
            Connect with verified talent across software, civil engineering, film & media, and education through Gradia's high-impact job melas.
          </p>

          {/* Industry pills */}
          <div className="flex flex-wrap justify-center gap-3 mb-8 animate-fade-in" style={{ animationDelay: '0.25s' }}>
            {[
              { icon: Briefcase, label: "Software & IT" },
              { icon: HardHat, label: "Civil Engineering" },
              { icon: Clapperboard, label: "Film & Media" },
            ].map((item, i) => (
              <div key={i} className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/15 text-white/80 text-sm">
