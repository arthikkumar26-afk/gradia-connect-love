...
import { Search, Filter, Eye, Pencil, Plus, Loader2, FilePlus2, ArrowRight, ChevronUp } from "lucide-react";
      ...
      <div className="space-y-6">
        ...
        <div className="bg-card rounded-2xl border border-border shadow-soft overflow-hidden">
          <div className="flex flex-col items-center justify-center py-10 px-6 text-center">
            ...
            >
              Templates
              {templatesOpen ? <ChevronUp className="h-5 w-5" /> : <ArrowRight className="h-5 w-5" />}
            </Button>
          </div>

          {/* Expandable Templates Section */}
          {templatesOpen && (
            <div className="border-t border-border px-6 py-6 space-y-5 animate-fade-in">
