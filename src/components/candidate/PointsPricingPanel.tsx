...
const FEATURE_COSTS: Array<{
  ...
  },
  {
    ...
    cost: 0,
    unit: "free",
    description: "Included free with every active wallet — re-runs anytime.",
    icon: Sparkles,
  ...
  },
  {
    ...
    cost: 0,
    unit: "unlimited",
    description: "Apply to unlimited jobs — no points deducted.",
    icon: Briefcase,
  ...
  },
  {
    ...
    cost: 0,
    unit: "Pro pack",
    description: "Auto-enabled when you load 1,000+ pts pack.",
    icon: UserCheck,
