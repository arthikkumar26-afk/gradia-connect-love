...
export const getSampleMockInterviewStageResults = (sessionId: string) => [
  ...
  },
  {
    ...
    session_id: sessionId,
    stage_name: 'Technical Assessment Slot Booking',
    stage_order: 2,
    ai_score: 100,
    ai_feedback: 'Slot booked successfully for Technical Assessment round.',
    passed: true,
    strengths: ['Completed slot booking on time', 'Provided all required details accurately'],
    improvements: [],
