  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex pt-16 lg:pt-0">
        ...
        <aside
          className={cn(
            "fixed lg:sticky top-16 lg:top-0 left-0 h-[calc(100vh-4rem)] lg:h-screen bg-card border-r transition-all duration-300 z-40",
        ...
        {/* Main Content */}
        <main className={cn("flex-1 transition-all duration-300", sidebarOpen ? "lg:ml-0" : "lg:ml-0")}>
