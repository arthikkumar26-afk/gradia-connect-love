...
import { ArrowLeft, ArrowRight, Users, Target, BarChart, Shield, Sparkles, Calendar, FileText, Award, Briefcase, GraduationCap, CheckCircle, Check, Upload, Wand2, Wallet, Star, CreditCard, Plus, Minus, Search } from "lucide-react";
...
const POINT_PACKAGES = [
  {
    ...
    rounds: 'Mock interviews included free',
    features: [
    ...
    excluded: ['AI feedback report', 'Featured profile boost'],
  },
  {
    points: 1000,
    price: 5000,
  ...
  },
  {
    ...
    features: [
      'Everything in Basic',
      'Mock Interviews — full 3-round flow',
  ...
  },
  {
    ...
    features: [
      'Everything in Pro',
      'Mock Interviews (full hiring pipeline)',
...
const TIER_MATRIX: { label: string; rows: { round: string; starter: string; basic: string; pro: string; premium: string }[] } = {
  ...
  rows: [
    ...
    { round: 'Mock interviews', starter: 'Included', basic: 'Included', pro: 'Included', premium: 'Included' },
