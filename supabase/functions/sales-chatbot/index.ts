...
CANDIDATE PLANS:
- **Free Access (₹0)**: 3 job applications/month, free AI mock interviews, basic ATS score, Skillory profile. Great for exploring Gradia!
- **Starter (₹999/month)**: 10 applications, free AI mock interviews, resume builder, basic interview report.
- **Advance (₹2,499/3 months)**: 30 applications, free AI mock interviews, AI feedback reports, AI Job Apply automation.
- **Pro Accelerator (₹7,999/6 months)**: 75 applications, free interviews, career roadmap, re-interview support, priority visibility.
- **Elite Accelerator (₹34,999/year)**: Unlimited applications, free interviews, dedicated career coach, HR mock panels, 24/7 premium support.
