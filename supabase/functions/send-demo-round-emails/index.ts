          ...
          <tr>
            <td style="padding: 14px 16px;">
              <p style="margin: 0; font-size: 13px; color: #166534;">
                <strong>💡 Tip:</strong> You can also attend your interviews directly from your <strong>Candidate Dashboard → Interview Pipeline</strong> tab. <a href="${baseUrl}/candidate/login" style="color: ${colors.primary}; text-decoration: underline;">Log in to your dashboard</a>
              </p>
            </td>
          </tr>
        </table>
