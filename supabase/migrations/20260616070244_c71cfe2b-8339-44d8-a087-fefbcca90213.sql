CREATE OR REPLACE FUNCTION public.start_mock_interview_session(p_interview_type text DEFAULT NULL::text, p_pipeline_type text DEFAULT NULL::text)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
